...
The exact generated classes encode shape, surface, motion, density and shadow choices. The original renderer remains responsible for semantic HTML and accessibility.
